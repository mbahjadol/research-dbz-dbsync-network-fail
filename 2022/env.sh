...
# export TOPIC_PREFIX="sqlsvrsqlsvr"
export TOPIC_PREFIX="s1"
...
export SYNC_TABLE_LIST="insert_lag,update_lag,customers,products,products_on_hand,orders,transactions" # WARNING: comma separated list of tables, value without spaces !
# export SYNC_TABLE_LIST="products_on_hand" # WARNING: comma separated list of tables, value without spaces !


# SQL SERVER Command Path
